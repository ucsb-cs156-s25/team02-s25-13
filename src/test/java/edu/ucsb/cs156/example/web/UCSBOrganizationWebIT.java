...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_organization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("ZETA PHI RHO DELTA");
        page.getByText("Update").click();

        assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslationShort")).hasText("ZETA PHI RHO DELTA");
